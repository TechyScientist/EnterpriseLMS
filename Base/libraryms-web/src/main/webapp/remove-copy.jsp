...
<% String pageName = "staff", pageTitle = "Delete Copy Record"; %>
...
<%      } else if(status == SC_ACCEPTED) { %>
            <p id="success"><img src="assets/img/check.png" alt="Success"/><strong>Success</strong>: Copy record deleted successfully.</p>
...
<h3>Delete a Copy Record</h3>
  <form action="" method="post">
      ...
      <button type="submit" id="remove-copy-submit" name="remove-copy-submit">Delete Patron Profile<img src="assets/img/proceed.png" alt="Proceed"/></button>
  </form>
